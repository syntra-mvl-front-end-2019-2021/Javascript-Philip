        ...
        fetchAllTodos() {
            ...
            fetch('https://phpstack-224488-1624928.cloudwaysapps.com/_/items/todo', {
                ...
                .then((result) => {
                    ...
                    console.log("🚀 ~ file: main.js ~ line 38 ~ .then ~ result.data", result.data)
            ...
            fetch(url, {
                ...
                .then((result) => {
                    if (this.activeTodoItem.id > 0) {
                        ...
                        console.log("🚀 ~ file: main.js ~ line 132 ~ .then ~ result", result)
                        console.log("🚀 ~ file: main.js ~ line 132 ~ .then ~ this.todoItems", this.todoItems)
                        console.log("🚀 ~ file: main.js ~ line 131 ~ .then ~ result.data", result.data)
                    }
